...
<ul>
<Appear>
  <li>Naming things is kinda hard</li>
  <li>More complex the markup, the more unique our selectors</li>
  <li>Using BEM is kinda hard</li>
  <li>There's a lot of complex markup in GFR</li>
  <li>BEM can be time consuming</li>
  <li>Naming things is a problem</li>
</Appear>
</ul>
